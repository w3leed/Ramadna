...
import test.demo.Ramadan.futureappspktime.widget.NextNotificationWidgetProvider;
import test.demo.Ramadan.futureappspktime.widget.TimetableWidgetProvider;
